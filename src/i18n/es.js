export default {
  ...
  patients: {
    ...
    day: "D\u00eda",
    time: "Hora",
    enterName: "Ingresa el nombre del {client.s}.",
  ...
  sessions: {
    ...
    cancelChargeExplain: "La {session.s} se cancelar\u00e1 pero se cobrar\u00e1 al {client.s}.",
  ...
  notes: {
    ...
    generalPatientNote: "Nota general del {client.s}",
  ...
  expediente: {
    ...
    period: "Per\u00edodo",
    periodFilterSub: "Filtra finanzas y asistencia del {client.s}",
