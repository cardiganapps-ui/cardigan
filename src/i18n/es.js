export default {
  ...
  payment: {
    ...
    trialNote: "Disfruta tu prueba gratuita. Te cobraremos $299 MXN al terminar tus {n} días restantes.",
    chargeNowNote: "Se cobrará $299 MXN ahora y cada mes. Cancela cuando quieras.",
    confirmTrialCta: "Confirmar y empezar prueba",
  ...
  subscriptionWelcome: {
    ...
    subtitle: "Tienes acceso completo a Cardigan. Sin tarjetas, sin compromisos.",
    feature1: "Pacientes, sesiones, pagos y notas \u2014 sin l\u00edmites.",
    feature2: "Recordatorios autom\u00e1ticos por correo y WhatsApp.",
    feature3: "Notas cifradas, calendario sincronizado y respaldo en la nube.",
    priceNote: "Despu\u00e9s de tu prueba",
    continueCta: "Empezar mi prueba",
    subscribeCta: "Suscribirme ahora",
    footer: "Sin contratos. Cancela cuando quieras desde la app.",
  },
  admin: {
