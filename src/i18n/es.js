export default {
  ...
  tutorial: {
    ...
    steps: {
      ...
      welcomeBody: "Cardigan organiza {client.p}, agenda, pagos y gastos en un solo lugar. Vamos a verlo.",
      ...
      fabBody: "El bot\u00f3n + es tu atajo principal: {client.p}, {session.p}, pagos, notas y gastos. Vive en cada pantalla.",
      drawerTitle: "Tu mapa de la app",
      drawerBody: "Toca el men\u00fa para llegar a Agenda, {client.P}, Finanzas, Cardi y Ajustes. Tambi\u00e9n abre con un swipe desde el borde izquierdo.",
      financesTitle: "Finanzas, todo junto",
      financesBody: "Cinco pesta\u00f1as: balances, pagos, gastos, resumen y proyecci\u00f3n. Tu contabilidad completa, sin hojas de c\u00e1lculo.",
      gastosTitle: "Gastos en segundos",
      gastosBody: "Adjunta foto del recibo y Cardigan llena monto, fecha y proveedor solita. Marca deducible o personal, agrega CFDI y deja que los recurrentes se generen sin que los toques.",
      resumenTitle: "P&L del mes y del a\u00f1o",
      resumenBody: "Ingresos \u2212 egresos = utilidad neta. Filtra por per\u00edodo, mira d\u00f3nde se va tu dinero por categor\u00eda y exporta CSV para tu contador con un clic.",
      ...
      portalTitle: "Portal del {client.s}",
      portalBody: "Comparte un enlace privado desde el {record.s} de cada {client.s}. Ver\u00e1n su pr\u00f3xima sesi\u00f3n, podr\u00e1n pagar en l\u00ednea y solicitar reagendados \u2014 t\u00fa apruebas o rechazas con un toque.",
