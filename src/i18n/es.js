export default {
  ...
  settings: {
    ...
    encLabel: "Cifrado de notas",
    encEnable: "Cifrar mis notas",
    encEnableSub: "Protege tus notas con una contraseña",
    encEnableCta: "Activar cifrado",
    encEnabledToast: "Cifrado activado. Tus próximas notas se guardarán cifradas.",
    encSetupExplain: "Establece una contraseña para cifrar tus notas. Esta contraseña es independiente de la de tu cuenta. Si la olvidas, podemos ayudarte a recuperar el acceso desde el equipo de soporte.",
    ...
    encStatus: "Cifrado activo",
    encStatusUnlocked: "Desbloqueado en esta sesión",
    encStatusLocked: "Bloqueado — ingresa tu contraseña al volver a entrar",
    encLockedHint: "Cierra y vuelve a abrir la app para ingresar la contraseña, o continúa sin desbloquear (las notas cifradas se mostrarán como “[cifrado]”).",
    encChange: "Cambiar contraseña de notas",
    encChangeSub: "Re-cifra tus notas con una nueva contraseña",
    encChangeCta: "Guardar nueva contraseña",
    encChangedToast: "Contraseña actualizada.",
    encDisable: "Desactivar cifrado",
    encDisableSub: "Las notas cifradas dejarán de ser legibles",
    encDisableCta: "Desactivar definitivamente",
    encDisableWarning: "Si desactivas el cifrado, las notas que ya están cifradas se vuelven permanentemente ilegibles. No las descifraremos automáticamente. Asegúrate de tener copia (vía Descargar mis datos) antes de continuar.",
