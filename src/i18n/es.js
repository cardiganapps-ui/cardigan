export default {
  ...
  settings: {
    ...
    notificationsRowTitle: "Recordatorios de sesión",
  },
  ...
  pro: {
    ...
    documents: {
      ...
      body: "Guarda PDFs, recetas, evaluaciones y más, todo enlazado a la ficha de cada paciente. Disponible con Cardigan Pro.",
    },
    encryption: {
    ...
    calendar: {
      ...
      body: "Lleva todas tus sesiones a Google Calendar, iCloud u Outlook con un solo enlace privado. Disponible con Cardigan Pro.",
    },
    default: {
  ...
  subscriptionSuccess: {
    ...
    feature1: "Carga documentos a la ficha de cada paciente",
    feature2: "Notas cifradas de extremo a extremo",
    feature3: "Sincroniza tus sesiones con tu calendario",
    cta: "Empezar",
  },
  activation: {
    title: "Configura tu Cardigan",
    subtitle: "Cuatro pasos rápidos para empezar.",
    stepPatient: "Agrega tu primer paciente",
    stepSession: "Registra tu primera sesión",
  ...
  milestone: {
    ...
    firstSession: "¡Primera sesión registrada! Cardigan calcula automáticamente lo que te deben.",
