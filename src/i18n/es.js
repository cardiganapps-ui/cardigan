export default {
  ...
  patients: {
    ...
    discardPotential: "Descartar {prospect.s}",
    discardConfirmTitle: "¿Descartar a {name}?",
    discardConfirmBody: "Quedará archivado y su {intake.s} se marcará como cancelada. Puedes consultarlo después en Archivados.",
    discardCta: "Sí, descartar",
    discardingToast: "{name} archivado en Potenciales",
  ...
  sessions: {
    ...
    interview: "{intake.S}",
    discardReason: "Potencial descartado",
    weekOf: "Semana del",
