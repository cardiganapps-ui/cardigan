export default {
  ...
  admin: {
    ...
    tabBugs: "Reportes",
    tabAudit: "Auditoría",
    auditDescription: "Recalcula los saldos de cada paciente desde cero y compara con los contadores. Detecta drift contable y sesiones duplicadas.",
    auditRun: "Ejecutar auditoría",
    auditRerun: "Volver a ejecutar",
    auditRunning: "Auditando…",
    auditFlaggedUsers: "Usuarios con anomalías",
    auditFlaggedUsersSub: "De los con drift / duplicados",
    auditDriftTotal: "Drift total",
    auditDriftSub: "MXN de discrepancia",
    auditDuplicates: "Sesiones duplicadas",
    auditDuplicatesSub: "(patient, fecha, hora)",
    auditFlaggedListTitle: "Top 50 usuarios con drift",
    auditClean: "✓ Sin drift contable detectado en ningún usuario.",
    auditPatientCount: "{count} pacientes",
    auditDupRow: "{n} duplicada(s)",
    auditRunAt: "Última corrida: {time}",
