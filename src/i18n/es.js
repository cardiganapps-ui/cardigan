export default {
  ...
  settings: {
    ...
    calendarRotateConfirm: "Al regenerar, los calendarios suscritos a la URL anterior dejarán de recibir actualizaciones. ¿Continuar?",
    calendarActive: "Tu calendario está sincronizado",
    calendarUrlNotShown: "Por seguridad, no guardamos la URL completa. Si necesitas volver a copiarla (p. ej. para un nuevo dispositivo), genera una nueva — los calendarios ya suscritos dejarán de recibir actualizaciones.",
    calendarUrlDisplayOnce: "Esta URL solo se mostrará una vez. Cópiala ahora si vas a usarla en otro dispositivo.",
    calendarRotationReminder: "Tu enlace tiene más de 90 días. Considera regenerarlo para reducir el riesgo si quedó expuesto.",
