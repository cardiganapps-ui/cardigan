...
// viewport (AuthScreen, PatientApp, etc.) AND as the auth/role
// loading splash. Mirrors the brand chrome so the boot sequence
// never disappears between transitions.
//
...
// centered white mark, no wordmark. Reason: iOS shows three potential
// splashes in sequence on cold start — LaunchScreen.storyboard
// (immediate, native), the SplashScreen plugin overlay (once the
// WebView starts), and finally React's first paint. Without this
// match, users saw a jarring "teal splash → white screen → app" flash.
