/* Psychologist note templates. These are the original Cardigan
   templates — clinical-flavoured and used by every existing user. */
export const PSYCHOLOGIST_TEMPLATES = [
  {
    id: "blank",
    name: "En blanco",
    icon: "edit",
