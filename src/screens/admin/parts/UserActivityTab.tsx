...
// eslint-disable-next-line @typescript-eslint/no-explicit-any -- loosely-typed profile/subscription/audit rows
type Row = any;
...
export function UserActivityTab({ profile, subscription, privacy, audit }: {
  ...
  const events = useMemo(() => {
    ...
    return out
      .filter((e: Row) => e.at)
      .sort((a: Row, b: Row) => (b.at || "").localeCompare(a.at || ""));
