...
// eslint-disable-next-line @typescript-eslint/no-explicit-any -- loosely-typed created-code row
type Row = any;
...
export function NewCodeSheet({ onClose, onCreated }: {
  ...
  const submit = async () => {
    ...
    try {
      ...
      setError((e as Error).message || t("admin.codesCreateError"));
      setBusy(false);
    }
  };
        ...
        <div style={{ padding: "4px 20px 24px" }}>
          ...
          <div className="input-group">
            ...
            <input
              ...
              type="text"
              value={code}
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => setCode(e.target.value.toUpperCase().replace(/[^A-Z0-9]/g, "").slice(0, 20))}
          ...
          <div className="input-group">
            ...
            <input
              ...
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => setInfluencerName(e.target.value.slice(0, 80))}
          ...
          <div className="input-group">
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <input
                ...
                max={100}
                value={percentOff}
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setPercentOff(e.target.value.replace(/[^0-9]/g, "").slice(0, 3))}
            ...
            <div className="input-group">
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                <input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setDurationInMonths(e.target.value.replace(/[^0-9]/g, "").slice(0, 2))}
          ...
          <div className="input-group">
            ...
            <input
              ...
              type="text"
              value={notes}
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => setNotes(e.target.value.slice(0, 500))}
              placeholder=""
            />
