              ...
              <>
                ...
                <div style={{ display:"flex", flexDirection:"column", gap:8, marginBottom:12 }}>
                  <a
                    ...
                    style={{ display:"flex", alignItems:"center", justifyContent:"center", gap:10, textDecoration:"none", background:"#000" }}
                  ...
                  >
                    ...
                    <span>{t("settings.calendarAddApple")}</span>
                  </a>
                  <a
                    href={googleAddUrl}
                    target="_blank"
                    ...
                    className="btn btn-primary"
                    style={{ display:"flex", alignItems:"center", justifyContent:"center", gap:10, textDecoration:"none", background:"#1a73e8" }}
                  ...
                  >
                    ...
                    <span>{t("settings.calendarAddGoogle")}</span>
                  </a>
                </div>

                <div style={{ background:"var(--amber-bg, #fff7e6)", color:"var(--charcoal-md)", fontSize:12, padding:"8px 12px", borderRadius:"var(--radius)", marginBottom:12, lineHeight:1.5 }}>
