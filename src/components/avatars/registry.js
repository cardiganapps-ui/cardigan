...
import {
  Dog, Cat, Plant, Coffee, Mountain, Abstract,
...
/* ── Cardigan preset avatar registry ────────────────────────────────
   ...
   Ids are stable — changing them strands users who already picked
   that preset (their user_metadata stores e.g. "preset:dog-01").
   The `-01` suffix leaves room for a future ship of refreshed
   variants (`dog-02`). */
...
export const PRESET_AVATARS = {
  ...
  "abstract-01": { label: "Abstracto", Component: Abstract },
