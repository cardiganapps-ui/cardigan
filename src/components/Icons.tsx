...
export const IconGlobe = (p: IconProps) => (
  <I {...p}><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 014 10 15.3 15.3 0 01-4 10 15.3 15.3 0 01-4-10 15.3 15.3 0 014-10z"/></I>
);
...
export const IconApple = ({ size = 18 }: { size?: number }) => (
  ...
  // inset gives the mark breathing room inside the circular button and
  // optically centers its bottom-heavy shape.
  <svg width={size} height={size} viewBox="-2 -2 28 28" aria-hidden="true" fill="currentColor">
    <path d="M12.152 6.896c-.948 0-2.415-1.078-3.96-1.04-2.04.027-3.91 1.183-4.961 3.014-2.117 3.675-.546 9.103 1.519 12.09 1.013 1.454 2.208 3.09 3.792 3.039 1.52-.065 2.09-.987 3.935-.987 1.831 0 2.35.987 3.96.948 1.637-.026 2.676-1.48 3.676-2.948 1.156-1.688 1.636-3.325 1.662-3.415-.039-.013-3.182-1.221-3.22-4.857-.026-3.04 2.476-4.494 2.592-4.572-1.429-2.09-3.623-2.324-4.39-2.376-2-.156-3.675 1.09-4.624 1.09zM15.53 3.83c.843-1.012 1.4-2.427 1.245-3.83-1.207.052-2.662.805-3.532 1.818-.78.896-1.454 2.338-1.273 3.714 1.338.104 2.715-.688 3.559-1.701z"/>
  </svg>
);
/* Face ID glyph — the trustworthy, recognizable mark for the passkey
...
export const IconFaceId = (p: IconProps) => (
  <I {...p}>
    ...
    <path d="M15 9.5v1"/>
    <path d="M12 9v3.5h-1"/>
    <path d="M9 15.2c.85.6 1.9.9 3 .9s2.15-.3 3-.9"/>
  </I>
);
