...
function verifyMetaSignature(rawBody: Row, headerVal: Row, appSecret: Row) {
...
async function handleVerify(req: Row, res: Row) {
...
async function handleEvent(req: Row, res: Row) {
